...
type RPCHanlder func(c *Connection, comm Communicator, payloadLen uint32) (uint32, []int, error)

// ChannelHandler handles the Channel RPC.
func ChannelHandler(c *Connection, comm Communicator, payloadLen uint32) (uint32, []int, error) {
