...
func (s *Stack) FindRoute(id tcpip.NICID, localAddr, remoteAddr tcpip.Address, netProto tcpip.NetworkProtocolNumber, multicastLoop bool) (*Route, tcpip.Error) {
	...
	isLinkLocal := (header.IsV6LinkLocalUnicastAddress(remoteAddr) ||
		header.IsV6LinkLocalMulticastAddress(remoteAddr) ||
		header.IsV4LinkLocalUnicastAddress(remoteAddr) ||
	...
	canForward := s.Forwarding(netProto) && !header.IsV6LinkLocalUnicastAddress(localAddr) && !header.IsV4LinkLocalUnicastAddress(localAddr) && !isLinkLocal
